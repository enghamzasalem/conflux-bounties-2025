...
async function main() {
  console.log("Deploying TokenVestingFactory to eSpace Testnet...");
  ...
  const adjustedGasPrice = (gasPrice.gasPrice * 200n) / 100n; // 100% increase for eSpace
  ...
  console.log("Estimated deployment cost:", ethers.formatEther(estimatedCost), "CFX");
  ...
  console.log("Total Cost:", ethers.formatEther(estimatedCost), "CFX");
